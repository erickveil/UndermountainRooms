...
QString AllTables::AdventurerRace()
{
    RandomTable table;
...
QString AllTables::adventurerPackage(int tier)
{
    RandomTable table;
...
QString AllTables::uncommonRace()
{
    RandomTable table;
