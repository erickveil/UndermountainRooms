...
QString CreatureActivity::friendlyHumanoidUrbanActivity()
{
    RandomTable table;
...
QString CreatureActivity::motivation()
{
    RandomTable table;
...
QString CreatureActivity::generateActivity()
{
    QString desc;
...
QString CreatureActivity::monsterDowntime()
{
    RandomTable table;
...
QString CreatureActivity::animalDowntime()
{
    RandomTable table;
...
QString CreatureActivity::creatureAttacksUrban()
{
    RandomTable table;
    ...
    table.addEntry("Tears arround the corner suddenly, face to face with "
                   "party");
    ...
    table.addEntry("A nobleman watches his creatures attack with glee from "
                   "afar.");
...
QString CreatureActivity::humanoidAttacksUrban()
{
     RandomTable table;
    ...
    table.addEntry("Hired mercenaries (less sneaky than the assassin "
                   "approach)");
    table.addEntry("Madness from illness or magic");
    table.addEntry("Work for one of the party's enemies");
    table.addEntry("Trying to prove themselves as superior and make a name "
                   "for themselves");
    table.addEntry("Disguised as beggars and the party does not pay them a "
                   "coin");
    table.addEntry("Press gang for pirate ship");
    table.addEntry("Actually harassing someone else unless the party "
                   "intervenes");
    table.addEntry("Have the way blocked off and are extracting tolls from "
                   "everyone before they can pass. (the Watch is never around "
                   "when you need them).");
    ...
    table.addEntry("Need to obtain really, really fresh dead bodies in "
                   "otherwise good physical health for a mage's experiment");
    table.addEntry("Racism");
    table.addEntry("Religious differences");
    table.addEntry("A disagreement of political ideals");
    table.addEntry("Philosophical differences - the party just isn't "
                   "nihilistic enough for them.");
    ...
    table.addEntry("Not in control of their own body and beg the party to "
                   "help them the entire time they attack them.");
    table.addEntry("They don't attack, but get the local Watch to think the "
                   "party is guilty of something they did, perhaps presenting "
                   "the Watch with a forged 'kill on sight' wanted poster, "
                   "framing the party as dangerous criminals.");
    table.addEntry("Attempt to lure the party into a dark alley or sewer "
                   "entrance or abandoned building before attacking.");
    table.addEntry("Don't attack but present the party with a too good to be "
                   "true once in a lifetime deal that is a scam. Get "
                   "mock-offended and violent if called out.");
    table.addEntry("Minding their own business, but someone else approaches "
                   "the party and offers a reward if they initiate the "
                   "attack.");
    table.addEntry("Stealing from a third party and the players witness it.");
    table.addEntry("Actually mounted and try to run down the party and flee. "
                   "Hit and run.");
    table.addEntry("Attack from the rooftops with ranged attacks.");
    table.addEntry("Actually just challenge the party to a friendly duel until "
                   "the other side submits.");
    table.addEntry("Pre-existing fight envelops the party.");
    table.addEntry("Someone shouts something political and the entire street "
                   "erupts into a riot around the party.");
    table.addEntry("They spot the party, curse, and take off running! Will "
                   "fight if chased around that corner.");
    table.addEntry("Slavers need slaves.");
    table.addEntry("Drive by shooting from the back of a horse-drawn wagon");
    table.addEntry("They are bounty hunters that have legitimate wanted "
                   "posters for the whole party. The issuer is not in this "
                   "town, and the bounty hunters don't care about the party's "
                   "story. Dead is easier than alive.");
    table.addEntry("Not attacking, but tailing the party. They hang back, but "
                   "keep the PCs in sight. They will wait a cross the street "
                   "when the party is in a building. They will follow until "
                   "provoked. They can be easily lost by trying.");
    table.addEntry("They just don't like wizards/rogues/fighters/whatever "
                   "class in their town.");
    table.addEntry("Member of the party is in a gang's territory while "
                   "inadvertently wearing the colors of rival gang.");
    ...
    table.addEntry("Guerilla tactics : strike with ranged attacks, run and "
                   "hide, repeat. Leading the party deeper into danger, "
                   "possibly over traps.");
    table.addEntry("Lure the party through a gate. Leads to another plane or "
                   "a death trap dungeon. Party must find a way to escape.");
